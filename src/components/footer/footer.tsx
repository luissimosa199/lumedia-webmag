      ...
      <div className="md:flex md:justify-around md:gap-4">
        <div className="mt-4 mb-4 text-gray-400">
          <div className="mb-4 flex gap-4 md:flex-col">
            <h3 className="font-semibold"><Link href="https://lumedia.vercel.app/privacy">Política de Privacidad</Link></h3>
            <h3 className="font-semibold"><Link href="https://lumedia.vercel.app/contact">Publicidad</Link></h3>
          </div>
        ...
        <div className="mb-4">
          ...
          <ul className="font-semibold text-gray-400">
            <li><Link href="https://lumedia.vercel.app/about">Sobre nosotros</Link></li>
            <li><Link href="https://lumedia.vercel.app/contact">Trabaja con nosotros</Link></li>
            <li><Link href="https://lumedia.vercel.app/contact">Contacto</Link></li>
          </ul>
        </div>
